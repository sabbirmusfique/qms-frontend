    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="info">
          ...
          <Card className="rounded-[32px] shadow-[0_20px_50px_rgba(0,0,0,0.08)] border-none max-w-full">
            ...
            <CardContent className="px-10 pb-10 space-y-6">
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {([
                    ...
                    <button key={o.v} onClick={() => setMode(o.v)} className={cn("p-4 rounded-lg border-2 transition flex flex-col items-center gap-2", mode === o.v ? "border-primary bg-accent text-accent-foreground" : "border-border hover:bg-muted")}>
              ...
              <div className="flex gap-2 pt-2">
                <Button onClick={() => toast.success("Appearance saved")} className="rounded-full">Save preferences</Button>
                <Button variant="outline" onClick={() => { reset(); toast.success("Reset to defaults"); }} className="rounded-full"><RotateCcw className="h-4 w-4 mr-2" />Reset</Button>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="activity" className="mt-4">
          <Card className="rounded-[32px] shadow-[0_20px_50px_rgba(0,0,0,0.08)] border-none max-w-full">
            <CardHeader className="px-10 pt-10 pb-4"><CardTitle>Recent Activity</CardTitle></CardHeader>
            <CardContent className="px-10 pb-10 space-y-2 text-sm">
              ...
              ].map((t, i) => <div key={i} className="p-3 rounded-lg bg-muted text-muted-foreground">{t}</div>)}
            </CardContent>
          </Card>
        </TabsContent>
      </Tabs>
